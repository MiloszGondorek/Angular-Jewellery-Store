...
export class ServerData {
  ...
  static collections: ServerCollection[] = [
    new ServerCollection(
      ...
      '/assets/uploads/collections/collection 1.png'
    ),
    new ServerCollection(
      'Oasis',
      ...
      '/assets/uploads/collections/collection 2.png'
    ),
    new ServerCollection(
      'Oceanic Serenade',
      ...
      '/assets/uploads/collections/collection 3.png'
    ),
    new ServerCollection(
      'Whispering Woods',
      ...
      '/assets/uploads/collections/collection 4.png'
    ),
  ];
